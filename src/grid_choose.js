      ...
      <div className="grid_choose">
        <div className="card_why">
          <div className="banner_grid">
            <h2 className="banner__title">Why you should buy DasBaby Token</h2>
            ...
            <p className="banner__text text text--small text--regular text--muted why-text">
              ...
              Organization (DAO) using the DasBaby Token for governance. No
              other Token rewards so aggressively for holding the Token. DasBaby
              is a Fair Launch token with no future minting allowed. Join us to
              the Moon!
            </p>
