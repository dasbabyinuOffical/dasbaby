    ...
    return (
      <section className="trade-securely">
        ...
        <div className="uniswap-widge">
          <iframe
            src="https://poocoin.app/embed-swap?outputCurrency=0x8e849671C0516Fd9A74075F2349A78390D52aa28"
            width="340"
            height="500"
            title="Buy DasBaby"
          ></iframe>
        ...
        <div className="road-body">
          <div className="card card--secondary">
            ...
            <p className="text text-small text--regular card__text">
              ...
              iOS/Android mobile device. This wallet will allow you to buy,
              sell, send, and receive DasBaby.
            </p>
            <a
          ...
          <div className="card card--white">
            ...
            <p className="text text-small text--regular card__text">
              You can buy BNB directly from exchanges like Binance, or a DEX.
              Make sure to use the BNB network when transferring BNB.
            </p>
          </div>
          <div className="card card--white">
            <div className="currency-icon">
            ...
            <p className="text text-small text--regular card__text">
              ...
              protocol. PancakeSwap will allow you to buy DasBaby.
            </p>
            <a
          ...
          <div className="card card--white">
            <div className="currency-icon2">
              <img alt="SwapDasBaby" src={SwapDasBaby} />
            </div>
            <div className="card__header">
              <h3>Swap BNB for DasBaby</h3>
            </div>
            <p className="text text-small text--regular card__text">
              You can start swapping as soon as you have BNB available! Press
