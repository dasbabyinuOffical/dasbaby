...
import coin from "./images/musk.jpeg";
import { Link as LinkR } from "react-scroll";
import Claim from "./images/claim-coin.svg";
import Typical from "react-typical";
var contractAddress = "0x8e849671C0516Fd9A74075F2349A78390D52aa28";
      ...
      <div className="header_body">
        <div className="grid_choose grid-gap--small">
          <div className="value-proposition">
            ...
            <p>
              {" "}
              Well this is your chance! DasBaby (<b>DasBaby Inu</b>) is here.
            </p>
            <div className="badge-container-add">
              ...
              <span
                ...
                className="text text--small text--regular text--white badge-add2"
              >
                {contractAddress}
              </span>
            </div>
